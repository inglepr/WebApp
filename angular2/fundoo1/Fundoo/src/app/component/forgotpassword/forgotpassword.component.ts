...
export class ForgotpasswordComponent implements OnInit {
  ...
  constructor(private router: Router, private http: HttpClient,private userService:UserService, private snackbar: MatSnackBar) { }
  ...
  onReset() {
    if (this.password === this.confirmPassword) {
      this.userService.createUser('/resetpassword?password=' + this.confirmPassword).subscribe(
        (response: any): any => {
